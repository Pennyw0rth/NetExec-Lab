...
- You can probably use the version of your package manager, but I would recommand using the lastest one from Oracle.
...
`pywinrm` is a library so it need to be install with `pip`.
